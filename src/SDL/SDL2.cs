...
/* Modified by Filip Radwaniecki <filip.radwaniecki@gmail.com> */
...
namespace SDL2
{
	public struct Ref<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] T> where T : unmanaged
	{
		...
		public Ref() { throw new InvalidOperationException(); }

		public Ref(IntPtr ptr)
		{
			Ptr = ptr;
		...
		public static implicit operator IntPtr(Ref<T> r) => r.Ptr;
	}
	...
	public static class SDL
	{
		...
		public static Ref<SDL_Surface> SDL_GetWindowSurface(IntPtr window)
		{
			IntPtr surfacePtr = INTERNAL_SDL_GetWindowSurface(window);
		...
		public static extern IntPtr INTERNAL_SDL_GetWindowSurface(IntPtr window);
		...
		public struct SDL_Color
		{
			...
			public static SDL_Color Red => new(255, 0, 0, 255);
			public static SDL_Color Green => new(0, 255, 0, 255);
			public static SDL_Color Blue => new(0, 0, 255, 255);
			public static SDL_Color White => new(255, 255, 255, 255);
			public static SDL_Color Black => new(0, 0, 0, 255);
			public static SDL_Color Transparent => new(0, 0, 0, 0);
			public static SDL_Color Yellow => new(255, 255, 0, 255);
			public static SDL_Color Cyan => new(0, 255, 255, 255);
			public static SDL_Color Magenta => new(255, 0, 255, 255);
		}
		...
		public struct SDL_Rect
		{
			...
			public static implicit operator SDL_Rect(in Rectangle rect)
			{
				return new()
				{
					x = rect.X,
